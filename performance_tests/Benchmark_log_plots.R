setwd("~/rip/results_new/logs/small_logs")
...
levels(total$Method) <- c(levels(total$Method), "MALT/HOPS")
total$Method[total$Method == 'malt'] <- 'MALT/HOPS'
...
levels(sample_500_melt$Method) <- c(levels(sample_500_melt$Method), "MALT/HOPS")
sample_500_melt$Method[sample_500_melt$Method == 'malt'] <- 'MALT/HOPS'
...
sample_500_melt$Method <- factor(sample_500_melt$Method, levels = c('Haystac', 'Sigma', 'Kraken2/Bracken', 'MALT/HOPS'))

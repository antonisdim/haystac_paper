...
/usr/bin/time -v kraken2-build --add-to-library db_mutlifasta_inputs/db_input_100_species.fasta --db db_kraken_100_species --threads $MAX_CPU
...
/usr/bin/time -v kraken2-build --add-to-library db_mutlifasta_inputs/db_input_10_species.fasta --db db_kraken_10_species --threads $MAX_CPU
...
/usr/bin/time -v kraken2-build --add-to-library db_mutlifasta_inputs/db_input_500_species.fasta --db db_kraken_500_species --threads $MAX_CPU
...
/usr/bin/time -v kraken2-build --add-to-library db_mutlifasta_inputs/db_input_5638_species.fasta --db db_kraken_5638_species --threads $MAX_CPU
...
/usr/bin/time -v kraken2-build --add-to-library db_mutlifasta_inputs/db_input_1000_species.fasta --db db_kraken_1000_species --threads $MAX_CPU

...
/usr/bin/time -v haystack analyse --mode abundances --database ./refseq_resp \
  --sample ./samples/input_100M_reads --output ./refseq_analysis_output_no_conda
...
/usr/bin/time -v haystack analyse --mode abundances --database ./refseq_resp \
  --sample ./samples/input_10M_reads --output ./refseq_analysis_output_no_conda
